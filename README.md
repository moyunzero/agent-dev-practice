...
**对齐 [AgentGuide](https://github.com/adongwanai/AgentGuide) 8 周开发岗路线 · Day 1–37 可独立运行的 Agent/RAG/Multi-Agent 代码 + 零基础自洽长文教程**
...
[![Week 6](https://img.shields.io/badge/Week_6-in__progress-yellow)](docs/ROADMAP.md)
...
| 覆盖 | 8 周全栈 Agent 工程 | Week 1–5 available（Day 1–35）；Week 6 in_progress（Day 36–37 available） |
...
| 6 | Multi-Agent | `in_progress` | AutoGen AgentChat（Day36–37）→ CrewAI（后续）→ [week06/README.md](week06/README.md) |
...
| 类型 | 涉及 Day | 说明 |
|------|----------|------|
| 仅 Ollama | 1–11, 15–20, 22, 26, 36–37 | 最轻；确保 `ollama serve` + 已 pull 模型 |
...
| AutoGen AgentChat | 36–37 | `autogen-agentchat` + `autogen-ext[ollama]`；需本机 Ollama |
...
```text
agent-dev-practice/
├── week01/ … week06/       # Day 1–37 练习（Week6 进行中）
...
Week 5（可观测 / 部署）已 available（Day 29–35），见 [week05/README.md](week05/README.md)。Week 6（Multi-Agent）进行中（Day 36–37 available），见 [week06/README.md](week06/README.md)。
</details>
